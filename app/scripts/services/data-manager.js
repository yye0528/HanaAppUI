            ...
            return {
                ...
                DTToStockPredition: function(rawData, xColName, yColName, group, oldData) {
                    ...
                    var getShape = function(trend) {
                        ...
                        if (yColName !== 'STOCK_CLOSE_PRICE' || group === 'input') return 'circle';
                    ...
                    _.each(rawData.values, function(element) {
                    		var JStime=d3.time.format('%m/%d/%Y').parse(element[columns.indexOf(xColName)]);
                        pointValues.push({
                            x: JStime,
                            y: element[columns.indexOf(yColName)],
